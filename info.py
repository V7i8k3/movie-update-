...
URL = "https://smartbot-sc1x.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://smartbot-sc1x.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://smartbot-sc1x.onrender.com".format(FQDN)
else:
    URL = "https://smartbot-sc1x.onrender.com".format(FQDN)
