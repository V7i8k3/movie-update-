...
URL = "https://smartfilterrbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://smartfilterrbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://smartfilterrbot.onrender.com/".format(FQDN)
else:
    URL = "https://smartfilterrbot.onrender.com/".format(FQDN)
