...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/suppoort21')
...
URL = "https://romi-8p7e.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://romi-8p7e.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://romi-8p7e.onrender.com/".format(FQDN)
else:
    URL = "https://romi-8p7e.onrender.com/".format(FQDN)
