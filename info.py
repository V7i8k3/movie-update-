...
API_ID = int(environ.get('API_ID', '29370150'))
API_HASH = environ.get('API_HASH', 'bbf3fbdc4062f45ac40a53f5192e226b')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '748544745').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002053338775').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002004324784')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001536620416')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001724209803')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Faheem:faheem@cluster0.cwb3vqq.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_fndkdiles')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviedataa2z')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/techazworlda2z')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/downloada2z3')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴏᴅɪғɪᴇᴅ ʙʏ  Bijendar Kumar  ❣️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002137164562'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviedataa2z')
...
URL = "https://raspy-tuna-faheem.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://raspy-tuna-faheem.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://raspy-tuna-faheem.koyeb.app/".format(FQDN)
else:
    URL = "https://raspy-tuna-faheem.koyeb.app/".format(FQDN)
