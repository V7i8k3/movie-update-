...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001945106784')
...
URL = "https://female-christie-faheem.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://female-christie-faheem.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://female-christie-faheem.koyeb.app/".format(FQDN)
else:
    URL = "https://female-christie-faheem.koyeb.app/".format(FQDN)
