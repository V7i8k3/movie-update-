...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Autofilter:Autofilter@cluster0.6db1cp8.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://romi-cidv.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://romi-cidv.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://romi-cidv.onrender.com/".format(FQDN)
else:
    URL = "https://romi-cidv.onrender.com/".format(FQDN)
