...
URL = "https://lunabotb-f5e417441bf8.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lunabotb-f5e417441bf8.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lunabotb-f5e417441bf8.herokuapp.com/".format(FQDN)
else:
    URL = "https://lunabotb-f5e417441bf8.herokuapp.com/".format(FQDN)
