...
URL = "https://romio-a0e9.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://romio-a0e9.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://romio-a0e9.onrender.com/".format(FQDN)
else:
    URL = "https://romio-a0e9.onrender.com/".format(FQDN)
