...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1321078922').split()]
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Files_TGxFiles')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'http://indianshortner.com')
...
URL = "https://smartfilterbot-46347a0f81d9.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://smartfilterbot-46347a0f81d9.herokuapp.com//".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://smartfilterbot-46347a0f81d9.herokuapp.com/".format(FQDN)
else:
    URL = "https://smartfilterbot-46347a0f81d9.herokuapp.com/".format(FQDN)
