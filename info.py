...
URL = "https://smartbot-17170ca1999f.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://smartbot-17170ca1999f.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://smartbot-17170ca1999f.herokuapp.com/".format(FQDN)
else:
    URL = "https://smartbot-17170ca1999f.herokuapp.com/".format(FQDN)
