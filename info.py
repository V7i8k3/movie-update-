...
URL = "https://fahee.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://fahee.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://fahee.onrender.com/".format(FQDN)
else:
    URL = "https://fahee.onrender.com/".format(FQDN)
